...
#determinar si está balancedf = pd.read_csv('/home/labo2023/Descargas/mnist_desarrollo.csv')
...
#%%
# =====================================================repo:gago1984/TP2-LaboratorioDeDatos-UBAExactas ========================
# Ejercicio 4
#Ajustar un modelo de knn considerando pocos atributos, por ejemplo 3.
#Probar con distintos conjuntos de 
...
Y = con_0s_y_1s.digitoclf = svm.SVC(kernel='linear', C=1, random_state=42)
